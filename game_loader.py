...
模块描述：
该模块是游戏类 是本游戏的主要模块
该类基本组合或者聚合了基本所有的类 就相当于一个棋盘,其它类相当于棋子
游戏类有game_running和game_running_singled_out两个相似的游戏方法
首先申明类然后调用其中一个方法可以开始游戏，两个方法的区别就是游戏模式的不同
其它的方法都是服务于这两个方法的 比如暂停方法，结束方法，检测键盘方法等
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("嘟粥版坦克大战")
        # 加载图片,音乐,音效.
